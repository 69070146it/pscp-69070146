...
```text
input:
เงินที่จ่ายคูณค่าบริการ ถ้าผลรวมเงินที่จ่ายน้อยกว่า 50 จะบวก vat 50 บาท มากกว่า 1000 บวก vat 1000 บาท
output:
ราคารวมที่ต้องจ่าย
```
...
```text
เอา input ไปคูณกับค่าบริการ และ ตรวจสอบ เงื่อนไขว่าได้ตรง test cases
```
...
```text
เพราะมันเป็นตัวอย่างจะได้ตรวจสอบว่าได้ตรงตามที่ต้องการมั้ย
```
...
```text
เพื่อตรวจสอบว่า ถ้าน้อยกว่า 50 จะบวกvat 50 บาทจริงมั้ย
```
...
```text
เพื่อตรวจสอบว่าเงื่อนไขว่าถ้ามากกว่า 1000 จะบวก vat 1000 ไหม
```
