...
```text
ใช้ for x in www เพื่อให้ค่าที่รับมาสามารถเพิ่มจำนวนแล้วprintออกมาได้ และ ใช้ .lower ทำให้ัตัวอักษรกลายเป็นพิมพ์เล็ก
```
...
```text
เพื่อตรวจสอบว่าผลลัพธ์ตรงกับเงื่อนไขมั้ย
```
...
```text
เพื่อดูว่าถ้าไม่มีสระจะออกมาเป็นยังไง
```
