...
```text
1.รับinputวันและเดือน
2.ตรวจว่าถ้าได้ใส่ข้อมูลไปเท่านี้จะได้ผลลัพธ์ออกมาตรงตามที่ต้องการมั้ย
```
...
```text
ก็เขียนไปว่า ถ้าเดือนมากกว่าสาม หรือ วันมากกว่า 21 ก็ให้แสดงออกมาเป็น spring แต่ ถ้าไม่ก้ให้เป็น winter แล้วก็ทำซ้ำไปตามเงื่อนไข ให้ครบทั้งสี่ฤดูกาล
```
