...
```text
input:
ค่าอุณหภูมิ และ หน่วยอุณหภูมิที่ยังไม่แปลง และ หน่วยอุณหภูมิที่ต้องการจะแปลง
output:
ค่าอุณหภูมิที่แปลงหน่วยแล้ว
```
...
```text
ใช้ if else elif แปลงหน่วยที่ input เข้ามาตัวแรกเป็น อีกตัว
```
...
```text
เพื่อตรวจสอบหน่วยที่แปลงว่าถูกหรือไม่
```
