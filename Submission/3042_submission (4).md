...
ใส่เลขหนึ่งจำนวน
output:
เลขที่หารด้วยสิบลงตัว จาก input จนถึง 0
```
...
```text
1.รับค่า
2.ตรวจสอบว่าเลขที่รับมาหารสิบลงตัวไหม
3.ทำให้เลขเรียงออกมา
```
...
```text
ใช้ for i in range() เพื่อให้เลขที่หารด้วยสิบลงตัวออกมา
```
...
```text
เพื่อตรวจสอบเลขที่ออกมาและหารสิบลงตัวไหม
```
