...
```text
ให้ใช้อิฐก้อนใหญ่ให้หมดก่อนแล้วค่อยใช้อิฐก้อนเล็กมาต่อสะพานให้ถึงจุดหมาย
...
```text
เพื่อตรวจสอบผลลัพธ์ว่าตรงตามเงื่อนไขไหม
```
